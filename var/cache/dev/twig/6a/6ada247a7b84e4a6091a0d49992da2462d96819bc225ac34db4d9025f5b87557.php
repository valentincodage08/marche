...
class __TwigTemplate_cd86c1edfef6113dded29dc6e77212c5447d2fb923452b0b6273fff3cdae89a3 extends Template
{
    private $source;
    private $macros = [];
...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "/Applications/MAMP/htdocs/git/symfony/marche/vendor/symfony/web-profiler-bundle/Resources/views/Collector/messenger.html.twig");
    }
}
