...
class __TwigTemplate_22126577baf9a022b3168e3d13d1aaa12ac53b0c55c895defd1b915f6b3b3a0a extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "/Applications/MAMP/htdocs/git/symfony/marche/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/email.html.twig");
    }
}
